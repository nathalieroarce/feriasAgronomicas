...
( 
   ...
   unit  BOOLEAN NOT NULL, --true sell in kg, false in bags
   image TEXT NOT NULL,
...
insert into products(
   ...
   description ,
   stock
) values(1,'Manzana','00rt',600,true,'manzanatestimage.png',3,'manzana del atlántico',30),
  (2,'Manzana2','00rt',600,true,'manzanatestimage.png',3,'manzana del atlántico',0),
  (3,'Manzana3','00rt',600,true,'manzanatestimage.png',3,'manzana del atlántico',10),
  (2,'Mango','00rt',600,true,'manzanatestimage.png',3,'mango del atlántico',0),
  (2,'Naranja','00rt',600,true,'manzanatestimage.png',3,'Naranja del atlántico',30),
  (3,'Piña','00rt',600,true,'manzanatestimage.png',3,'Piña del atlántico',10);
